...
- **2026-03-30:** Tundra (Al) oil change scheduled — 4/3/26. Oil spec confirmed: 0w-30 full synthetic, 7.9 qt with filter (summer towing season). Maintenance-Log.md created for Al. Google Calendar integration planned — see next-actions for required secrets.
