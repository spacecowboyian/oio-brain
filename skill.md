...
Only after orienting yourself should you read domain-specific files in the appropriate domain folders.
...
│   └── next-actions.md
│
├── brand/, cars/, content/, events/,  ← Canonical knowledge by domain
│   production/, business/, ops/
...
All new files in domain folders, `core/`, and `active/` must include this frontmatter block:
...
6. **Never delete** `intake/docs/dailies/` itself or `intake/docs/dailies/README.md`
...
- Cross-cutting arcs (championship, Fit-Off) live in `02 - Content/Season-Story-Arcs.md`
...
- See `01 - Brand/Social-Post-Voice.md` for the canonical voice guide, tone buckets, post patterns, CTAs, and hashtag strategy
...
8. **Always delete source files** from `intake/docs/` and `intake/docs/dailies/` after processing.
...
|---|---|
| Brand voice, tone, persona | `01 - Brand/` |
| Video ideas and pipeline | `02 - Content/` |
| Car builds and maintenance | `03 - Cars/[Driver]/[Car]/` |
| Race results and events | `04 - Events/` |
| Filming and editing SOPs | `05 - Production/` |
| Budget and business | `06 - Business/` |
| Contacts and accounts | `07 - Admin/` |
...
| Daily transcript summaries | `02 - Content/Summaries/` |
