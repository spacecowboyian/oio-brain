...
- **2026-04-01:** Legacy caption drafts cleaned up — 17 pre-generated caption drafts (OUT-48–OUT-64) for 2025 video backlog removed from `OIO Brain/02 - Content/Caption-Drafts/`. Workflow shift: captions now generated on-demand as new videos are posted rather than pre-batched. README updated to document cleanup. Changes pushed to GitHub (Paperclip OUT-166).
