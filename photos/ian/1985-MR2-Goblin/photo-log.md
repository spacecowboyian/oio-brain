---
title: The Goblin — Photo Log
type: reference
status: active
owner: Ian Jennings
updated: 2026-03-28
tags: [photos, mr2, goblin, ian, rallycross]
source_of_truth: false
summary: Master photo log for The Goblin (1985 Toyota MR2 AW11). Tracks every photo in this folder — context, event, social media post history, and what was visible in the shot.
---

# The Goblin — Photo Log

> All photos of The Goblin (1985 Toyota MR2 AW11). Each entry notes what the photo shows, when and where it was taken, and whether it has been posted to social media.

---

## Photo Index

| Filename | Date | Event / Context | Subject | Posted | Post Caption |
|---|---|---|---|---|---|
| [IMG_8181.png](IMG_8181.png) | Unknown | KCRSCCA Rallycross (estimated) | Action shot — sliding on dirt course | No | — |
...
**Notes:**
Excellent action shot. Strong dust plume. Good candidate for Instagram or YouTube thumbnail.
